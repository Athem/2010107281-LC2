...
namespace _2010107281_MVC.Controllers
{
    public class VentaPaqueteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VentaPaqueteId,ComprobantePagoId")] VentaPaquete ventaPaquete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VentaPaqueteId,ComprobantePagoId")] VentaPaquete ventaPaquete)
        {
            if (ModelState.IsValid)
            {
